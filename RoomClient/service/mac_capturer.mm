...
@interface MacVideoSourceAdapter
...
MacCapturer *MacCapturer::Create(size_t width, size_t height, size_t target_fps,
                                 size_t capture_device_index) {
...
#pragma clang diagnostic ignored "-Wunused-variable"
  MacVideoSourceAdapter *adapter =
      (__bridge_transfer MacVideoSourceAdapter *)adapter_;
  RTC_OBJC_TYPE(RTCCameraVideoCapturer) *capturer =
