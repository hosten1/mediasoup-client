#ifndef ROOMCLIENT_SERVICE_PARTICIPATION_CONTROLLER_H_
#define ROOMCLIENT_SERVICE_PARTICIPATION_CONTROLLER_H_
...
public:
  ...
  void addObserver(
      std::shared_ptr<IParticipantControllerObserver> observer) override;
...
#endif // ROOMCLIENT_SERVICE_PARTICIPATION_CONTROLLER_H_
